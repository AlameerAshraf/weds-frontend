...
export class constants {
  ...
  public static get APP_IDENTITY_FOR_USERS(): string {
    return this._config.getConfig("CLIENT_IDENTITY_USERS");
  }
  public static get APP_IDENTITY_FOR_ADMINS(): string {
    return this._config.getConfig("CLIENT_IDENTITY_ADMINS");
  }

  public static get SERVER_ERROR(): string {
    return this._config.getConst("SERVER_ERROR_MESSAGE");
  }
  public static get BFO_LOADING_ERROR(): string {
    return this._config.getConst("BFO_LOADING_ERROR");
  }
  public static get SUCCESSFULL_SAVING(): string {
    return this._config.getConst("SUCCESSFULL_SAVING");
  }
  public static get FAILURE_SAVING(): string {
    return this._config.getConst("FAILURE_SAVING");
  }
  public static get LOGGED_IN_USER(): string {
    return this._config.getConst("LOGGED_IN_USER");
  }
  public static get LOGGED_IN_USER_ROLES(): string {
    return this._config.getConst("LOGGED_IN_USER_ROLES");
  }
  public static get BASE_URL(): string {
    return this._config.getConfig("BASE_URL");
  }

  public static get FACEBOOK_APP_ID(): string {
    return this._config.getConfig("FACEBOOK_OAUTH_APP_ID_DEBUGE");
  }
  public static get GOOGLE_CLIENT_ID(): string {
    return this._config.getConfig("GOOGLE_OAUTH_CLIENT_ID");
  }
}
