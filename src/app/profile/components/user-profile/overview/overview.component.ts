...
export class OverviewComponent implements OnInit {
  ...
  getAllUserFeaturesCount() {
    this.ngxSpinner.show();
    let getAllItemsURL = `${urls.GET_ALL_USER_FEATURES_COUNT}/${constants.APP_IDENTITY_FOR_USERS}/${this.currentUserEmail}`;
